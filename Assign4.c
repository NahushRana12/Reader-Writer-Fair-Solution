/* compile with gcc -ofname assign4.c -lpthread */
/* reader-writer problem with mutex locks */
/* to make it fair i have used mutex flag which is stop all the upcoming reader_thread to assign Crtitical section when writer_thread want to update the shared varible and will unlock upcoming reader_thread when writer_thread stop executing.*/
